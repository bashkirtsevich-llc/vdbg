...
{$ENDIF}
    ...
    *)
    ...
    procedure AttachMemory(aMemory: pointer; aLength: integer);
...
procedure TCustomMPHexEditor.AttachMemory(aMemory: pointer; aLength: integer);
begin
  try
    FreeStorage;
    FreeStorage(True);

    FDataStorage.SetPointer(aMemory, aLength);
  except
    FreeStorage;
    FreeStorage(True);
  end;
